...
_s(Home, "x8oQnmrW6r07crOmVjUzMDADfKY=", false, function() {
    return [
...
function ChatRoom({ user }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ChatRoom.useEffect": ()=>{
            const loadMessages = {
                "ChatRoom.useEffect.loadMessages": async ()=>{
            ...
            }["ChatRoom.useEffect.loadMessages"];
            loadMessages();
            const channel = supabase.channel('global-chat').on('postgres_changes', {
                ...
                "ChatRoom.useEffect.channel": (payload)=>{
...
_s(ChatRoom, "0hUnTWerGK4B/t4LmukVsZ6kc3I=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Feed.useEffect": ()=>{
            const calculateTimeLeft = {
                "Feed.useEffect.calculateTimeLeft": ()=>{
                    const now = new Date();
            ...
            return ({
                "Feed.useEffect": ()=>clearInterval(timer)
            })["Feed.useEffect"];
        }
    }["Feed.useEffect"], []);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(Feed, "vwewljmB3jrOpG1la7jDMqsJLWg=");
_c = Feed;
var _c;
...
//# sourceMappingURL=src_0868nwi._.js.map